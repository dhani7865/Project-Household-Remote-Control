...
public class SensorData {
	...
	public SensorData(String sensorname, String sensorvalue) {
		...
		this.userid = "16038287";
		this.sensorname = "1600ee15e9";
		this.sensorvalue = "Open";
		this.sensordate = "unknown";
	} // Close constructor for SensorData
	
	// Creating public sensor data method for the sensor value
